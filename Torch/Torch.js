        ...
        if( found ) {
            ...
            if(fobj) {
                fobj.set({
                    ...
                    directional_bright_light_total: a,
                    has_directional_dim_light: true,
                    directional_dim_light_total: a,
                    light_angle: a,
        ...
        switch(args[0]) {
            case '!torch': {
                ...
                let props = {
                    ...
                    has_directional_bright_light: true,
                    directional_bright_light_total: arc_angle,
                    directional_bright_light_center: 0,
                    has_directional_dim_light: true,
                    directional_dim_light_total: arc_angle,
                ...
                _.each(_.union(objs,_.map(msg.selected,function (o) {
                    ...
                    o.set( props );
                    forceLightUpdateOnPage(o.get('pageid'));
                });
            }
                break;
            ...
            case '!snuff': {
                ...
                _.each(msg.selected,function (o) {
                    getObj(o._type,o._id).set(props);
                });
            }
                break;
            ...
            .each(function(fdata){
                ...
                if(!o) {
                    ...
                    if(!f) {
                        ...
                        dx = randomInteger(Math.max(2 * flickerDeltaLocation,0))-flickerDeltaLocation;
